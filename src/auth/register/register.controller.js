...
var RegisterController = /** @class */ (function () {
    ...
    RegisterController.prototype.register = function (registerUserDto) {
        return __awaiter(this, void 0, void 0, function () {
            var code;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.registerService.createUser(registerUserDto)];
                    case 1:
                        code = _a.sent();
                        if (code === 'email') {
                            throw new common_1.HttpException('Такой email уже зарегистрирован на платформе', 406);
                        }
                        else if (code === 'phone') {
                            throw new common_1.HttpException('Такой телефон уже зарегистрирован на платформе', 405);
                        }
                        else {
    ...
    __decorate([
        (0, common_1.Post)('api/v1/auth/register'),
