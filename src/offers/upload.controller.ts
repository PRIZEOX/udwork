...
@UseGuards(JwtGuard)
@Controller()
export class UploadOfferController {
  constructor(
    private offersService: OffersService,
    private picturesService: PicturesService,
  ) {}
  @Post('api/v1/offer/media/upload')
  @ApiTags('Users')
  @ApiOperation({
    description:
  ...
  async uploadFile(@UploadedFile() file: Express.Multer.File, @Req() req) {
    switch (file.filename) {
      ...
      default:
        return await this.offersService.savePublicPicture(req.user.sub, file);
    }
  }
}
