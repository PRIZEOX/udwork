export const pril2 = (user, code, operator) => {
...
<div class="main">
  ...
  <br/>
  <p>
    Заявитель - инвестор (физическое лицо). </br>
    Инвестор:
  </p>
<!--  <div style="background-color:#000000; width:100%; font-size:1px; height:2px;">&nbsp;</div>-->
  <table border="1" cellpadding="2" cellspacing="2" style="border-collapse: collapse; width: 100%; font-family: Arial;">
    <tbody >
    <tr>
      <td>ИНН</td>
      <td>${user.inn}</td>
