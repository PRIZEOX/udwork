...
var UploadController = /** @class */ (function () {
    function UploadController(usersService) {
    ...
    UploadController.prototype.uploadFile = function (file, req) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersService.saveUserPicture(req.user.sub, file)];
    ...
    __decorate([
        (0, common_1.Post)('api/v1/media/upload'),
        ...
        (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', {
            storage: (0, multer_1.diskStorage)({
                ...
                filename: function (req, file, cb) {
                    var logger = new common_1.Logger(users_service_1.UsersService.name);
